...
<html lang="zxx">
    ...
    <body>
                        ...
                        <div class="wrapper">
                            ...
                            <div class="product-sec1">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    <c:url value="/UpdateDetail" var="addURL" />
                                <form action="${addURL}" method="post">
                                    <c:forEach items="${list}" var="u">
                                        <tr>
                                        <input type="hidden" name="hid" value="${u.hid}">
                                        <td>${u.hid}</td>
                                        <td>${u.sid}</td>
                                        <td>${u.quantity}</td>
                                        <td>${u.price}</td>
                            ...
                            <div class="form-group col-md-1">
                                <input type="radio" name="status" id="status" class="form-control" value="0" >Done
                            </div>
                            <div class="form-group col-md-1">
                                <input type="radio" name="status" id="status" class="form-control" value="1" >Wait
                            </div>
                    ...
                    <div class="col-sm-5 address-right">
                        <div class="col-xs-6 footer-grids">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="product.html">Computer Acc</a>
                                </li>
        ...
        <div class="copy-right">
            <div class="container">
                <p>© 2017 Computer Shoppy. All rights reserved | Design by
