                ...
                <div class="side-bar col-md-3">
                    ...
                    <div class="agileinfo-ads-display col-md-9">
                        ...
                        <div class="wrapper">
                            ...
                            <c:url value='/AddProductController' var="addURL" />
                            <a class="btn btn-primary" href="${addURL}">Add New Product</a>
                                    ...
                                    <c:forEach items="${list}" var="u">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <c:url value='/EditProductController?id=${u.sid}' var="editURL" />
                                                <a href="${editURL}" class="btn btn-warning">Edit</a> 
                                                <c:url value='/DeleteProductController?id=${u.sid}' var="deleteURL" /> 
                                                <a  href="${deleteURL}" class="btn btn-danger">Delete</a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
