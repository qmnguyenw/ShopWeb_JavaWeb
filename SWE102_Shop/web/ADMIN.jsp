    ...
    <body>
            ...
            <div class="header-bot_inner_wthreeinfo_header_mid">
                ...
                <div class="col-md-8 header">
                    ...
                    <ul>
                        ...
                        <li>
                            <span class="fa fa-phone" aria-hidden="true"></span> blank
                        </li>
                        <li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body modal-body-sub_agile">
                        ...
                        <div class="modal_body_left modal_body_left1">
                            ...
                            <p>
                                Come join the Computer Shop PV! Let's set up your Account.
                            </p>
                            <form action="#" method="post">
                                <div class="styled-input agile-styled-input-top">
        ...
        <footer>
            <div class="container">
                ...
                <p class="footer-main">
                    <span>"Computer Shoppy"</span> Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur
                ...
                <div class="footer-info w3-agileits-info">
                    ...
                    <div class="col-sm-5 address-right">
                        <div class="col-xs-6 footer-grids">
                            ...
                            <ul>
                                <li>
                                    <a href="product.html">Computer</a>
                                </li>
                                <li>
                                    <a href="product.html">Computer Accessories</a>
                                </li>
                                <li>
                                    <a href="product.html">Networking Products</a>
                                </li>
                                <li>
                                    <a href="product2.html">Computer Components</a>
                                </li>
                                <li>
                                    <a href="product.html">Data Storage</a>
                                </li>
                                <li>
                                    <a href="product2.html">Printers</a>
                                </li>
                            </ul>
                        </div>
                        <div class="clearfix"></div>
