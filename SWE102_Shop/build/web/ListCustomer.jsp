                ...
                <div class="side-bar col-md-3">
                    ...
                    <div class="agileinfo-ads-display col-md-9">
                        ...
                        <div class="wrapper">
                            ...
                            <c:url value='/AddCustomerController' var="addURL" />
                            <a class="btn btn-primary" href="${addURL}">Add New User</a>
                                    ...
                                    <c:forEach items="${list}" var="u">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <c:url value='/EditCustomerController?id=${u.cid}' var="editURL" />
                                                <a href="${editURL}" class="btn btn-warning">Edit</a> 
                                                
                                                <c:url value='/DeleteCustomer?id=${u.cid}' var="deleteURL" /> 
